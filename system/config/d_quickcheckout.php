<?php 
$_['d_quickborrow_debug'] = 0;
$_['d_quickborrow_debug_file'] = 'd_quickborrow.log';
$_['d_quickborrow_trigger'] = '#button-confirm, .button, .btn, .button_oc, input[type=submit]';
$_['d_quickborrow_setting'] = array(
	'version' => '',
	'name' => 'default',
	'general' => array(
		'enable' => 0,
		...
		'social_login' => 0,
		'analytics_event' => 0,
		'loader' => 'catalog/d_quickborrow/svg-loaders/puff.svg',
		'compress' => 1,
	),
	'design' => array(
		'theme' => 'default',
			...
			'confirm' => array(
				...
				'fields' => array(
					...
					'agree' => array(
							'id' => 'agree',
							'title' => 'text_agree',
							//'information_id' => $this->config->get('config_borrow_id'),
							'tooltip' => '',
							'error' => array(0 => array('checked' => true,
													 'text' => 'error_agree',
											 		  //'information_id' => $this->config->get('config_borrow_id')
