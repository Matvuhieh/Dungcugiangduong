...
class scssc {
	...
	protected $staffFunctions = array();
	...
	public function registerFunction($name, $func) {
		$this->staffFunctions[$this->normalizeName($name)] = $func;
	}

	public function unregisterFunction($name) {
		unset($this->staffFunctions[$this->normalizeName($name)]);
	}
	...
	protected function callBuiltin($name, $args, &$returnValue) {
		...
		} elseif (isset($this->staffFunctions[$name])) {
			// see if we can find a staff function
			$fn = $this->staffFunctions[$name];
