...
class PHPExcel_Calculation_Statistical
{
     ...
     * CORREL
     *
     * Returns covariance, the average of the instruments of deviations for each data point pair.
     *
...
//            $CumPGuessMinus1 = $CumPGuess - $PGuess;
     ...
     * RSQ
     *
     * Returns the square of the Pearson instrument moment correlation coefficient through data points in known_y's and known_x's.
     *
     * @param    array of mixed        Data Series Y
     * @param    array of mixed        Data Series X
     * @return    float
