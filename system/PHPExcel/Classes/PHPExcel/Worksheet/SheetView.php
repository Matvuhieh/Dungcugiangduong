...
class PHPExcel_Worksheet_SheetView
{
    ...
    {
        // Microsoft Office Excel 2007 only allows setting a scale between 10 and 400 via the staff interface,
    ...
    {
        // MS Excel 2007 allows setting the view to 'normal', 'pageLayout' or 'pageBreakPreview' via the staff interface
        if ($pValue === null) {
