...
// --------------------------------------------------------------------------------
// Adapted from Excel_Spreadsheet_Reader developed by staffs bizon153,
...
//     Support for staff-defined named cells added as an array "namedcells"
//         Patch code for staff-defined named cells supports single cells only.
...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    /**
     * Staff-Defined Properties stream data.
     *
     * @var string
     */
    private $staffDefinedProperties;
...
//                    echo '<br />';
    ...
    private function loadOLE($pFilename)
    {
        ...
        // Get staff-defined property data
//        $this->staffDefinedProperties = $ole->getStaffDefinedProperties();
    }
...
//            echo 'Type is ', $type,', ';
            ...
            switch ($id) {
                ...
                case 0x0D:    //    Titles of Parts
                    ...
                    break;
                case 0x0E:    //    Orderr
                    $this->phpExcel->getProperties()->setOrderr($value);
                    break;
                case 0x0F:    //    Company
...
//        echo '<br />';
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if (isset($this->formats[$numberFormatIndex])) {
                // then we have staff-defined format code
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            // bit: 15; mask 0x8000; 0 = staff-defined style, 1 = built-in style
            ...
            if ($isBuiltIn) {
                ...
                // staff-defined; not supported by PHPExcel
            }
        }
    }
    ...
    private function readDefinedName()
    {
        ...
        if ($this->version == self::XLS_BIFF8) {
            ...
            // bit: 5; mask: 0x0020; 0 = staff-defined name, 1 = built-in-name
...
//        echo '<br />';
    ...
    private function readSheetProtection()
    {
        ...
        // bit: 0; mask 0x0001; 1 = staff may edit objects, 0 = staffs must not edit objects
