...
//  * 1D and 2D barcodes: CODE 39, ANSI MH10.8M-1983, USD-3, 3 of 9, CODE 93, USS-93, Standard 2 of 5, Interleaved 2 of 5, CODE 128 A/B/C, 2 and 5 Digits UPC-Based Extension, EAN 8, EAN 13, UPC-A, UPC-E, MSI, POSTNET, PLANET, RMS4CC (Royal Mail 4-state User Code), CBC (User Bar Code), KIX (Klant index - User index), Intelligent Mail Barcode, Onecode, USPS-B-3200, CODABAR, CODE 11, PHARMACODE, PHARMACODE TWO-TRACKS, Datamatrix, QR-Code, PDF417;
 ...
 * <li>1D and 2D barcodes: CODE 39, ANSI MH10.8M-1983, USD-3, 3 of 9, CODE 93, USS-93, Standard 2 of 5, Interleaved 2 of 5, CODE 128 A/B/C, 2 and 5 Digits UPC-Based Extension, EAN 8, EAN 13, UPC-A, UPC-E, MSI, POSTNET, PLANET, RMS4CC (Royal Mail 4-state User Code), CBC (User Bar Code), KIX (Klant index - User index), Intelligent Mail Barcode, Onecode, USPS-B-3200, CODABAR, CODE 11, PHARMACODE, PHARMACODE TWO-TRACKS, Datamatrix, QR-Code, PDF417;</li>
...
class TCPDF {
	...
	/**
	 * Scale factor (number of points in staff unit).
	 * @protected
	 */
	protected $k;
	...
	/**
	 * Current width of page in staff unit.
	 * @protected
	 */
	protected $w;

	/**
	 * Current height of page in staff unit.
	 * @protected
	 */
	protected $h;
	...
	/**
	 * Current horizontal position in staff unit for cell positioning.
	 * @protected
	 */
	protected $x;

	/**
	 * Current vertical position in staff unit for cell positioning.
	 * @protected
	 */
	protected $y;
	...
	/**
	 * Current font size in staff unit.
	 * @protected
	 */
	protected $FontSize;
	...
	/**
	 * Adjusting factor to convert pixels to staff units.
	 * @since 2004-06-14
	 * @author Nicola Asuni
	 * @protected
	 */
	...
	/**
	 * Width of header image logo in staff units.
	 * @protected
	 */
	 ...
	 * @param $unit (string) Staff measure unit. Possible values are:<ul><li>pt: point</li><li>mm: millimeter (default)</li><li>cm: centimeter</li><li>in: inch</li></ul><br />A point equals 1/72 of inch, that is to say about 0.35 mm (an inch being 2.54 cm). This is a very common unit in typography; font sizes are expressed in that unit.
	 ...
	 * <li>['CropBox'] : the visible region of default staff space:</li>
	 ...
	 * <li>['BleedBox'] : the region to which the contents of the page shall be clipped when output in a instrumention environment:</li>
	 ...
	 * <li>['BoxColorInfo'][BOXTYPE]['W'] : the guideline width in default staff units</li>
	...
	protected function setPageFormat($format, $orientation='P') {
		...
		if (is_string($format)) {
			...
			// the visible region of default staff space
			...
			// the region to which the contents of the page shall be clipped when output in a instrumention environment
	...
	/**
	 * Set the adjusting factor to convert pixels to staff units.
	 * @param $scale (float) adjusting factor to convert pixels to staff units.
	 * @author Nicola Asuni
	 * @public
	 * @since 1.5.2
	 */
	...
	/**
	 * Returns the adjusting factor to convert pixels to staff units.
	 * @return float adjusting factor to convert pixels to staff units.
	 * @author Nicola Asuni
	 * @public
	 * @since 1.5.2
	 */
	 ...
	 * <ul><li>$this->pagedim[$this->page]['w'] = page width in points</li><li>$this->pagedim[$this->page]['h'] = height in points</li><li>$this->pagedim[$this->page]['wk'] = page width in staff units</li><li>$this->pagedim[$this->page]['hk'] = page height in staff units</li><li>$this->pagedim[$this->page]['tm'] = top margin</li><li>$this->pagedim[$this->page]['bm'] = bottom margin</li><li>$this->pagedim[$this->page]['lm'] = left margin</li><li>$this->pagedim[$this->page]['rm'] = right margin</li><li>$this->pagedim[$this->page]['pb'] = auto page break</li><li>$this->pagedim[$this->page]['or'] = page orientation</li><li>$this->pagedim[$this->page]['olm'] = original left margin</li><li>$this->pagedim[$this->page]['orm'] = original right margin</li><li>$this->pagedim[$this->page]['Rotate'] = The number of degrees by which the page shall be rotated clockwise when displayed or printed. The value shall be a multiple of 90.</li><li>$this->pagedim[$this->page]['PZ'] = The page's preferred zoom (magnification) factor.</li><li>$this->pagedim[$this->page]['trans'] : the style and duration of the visual transition to use when moving from another page to the given page during a presentation<ul><li>$this->pagedim[$this->page]['trans']['Dur'] = The page's display duration (also called its advance timing): the maximum length of time, in seconds, that the page shall be displayed during presentations before the viewer application shall automatically advance to the next page.</li><li>$this->pagedim[$this->page]['trans']['S'] = transition style : Split, Blinds, Box, Wipe, Dissolve, Glitter, R, Fly, Push, Cover, Uncover, Fade</li><li>$this->pagedim[$this->page]['trans']['D'] = The duration of the transition effect, in seconds.</li><li>$this->pagedim[$this->page]['trans']['Dm'] = (Split and Blinds transition styles only) The dimension in which the specified transition effect shall occur: H = Horizontal, V = Vertical. Default value: H.</li><li>$this->pagedim[$this->page]['trans']['M'] = (Split, Box and Fly transition styles only) The direction of motion for the specified transition effect: I = Inward from the edges of the page, O = Outward from the center of the pageDefault value: I.</li><li>$this->pagedim[$this->page]['trans']['Di'] = (Wipe, Glitter, Fly, Cover, Uncover and Push transition styles only) The direction in which the specified transition effect shall moves, expressed in degrees counterclockwise starting from a left-to-right direction. If the value is a number, it shall be one of: 0 = Left to right, 90 = Bottom to top (Wipe only), 180 = Right to left (Wipe only), 270 = Top to bottom, 315 = Top-left to bottom-right (Glitter only). If the value is a name, it shall be None, which is relevant only for the Fly transition when the value of SS is not 1.0. Default value: 0.</li><li>$this->pagedim[$this->page]['trans']['SS'] = (Fly transition style only) The starting or ending scale at which the changes shall be drawn. If M specifies an inward transition, the scale of the changes drawn shall progress from SS to 1.0 over the course of the transition. If M specifies an outward transition, the scale of the changes drawn shall progress from 1.0 to SS over the course of the transition. Default: 1.0. </li><li>$this->pagedim[$this->page]['trans']['B'] = (Fly transition style only) If true, the area that shall be flown in is rectangular and opaque. Default: false.</li></ul></li><li>$this->pagedim[$this->page]['MediaBox'] : the boundaries of the physical medium on which the page shall be displayed or printed<ul><li>$this->pagedim[$this->page]['MediaBox']['llx'] = lower-left x coordinate in points</li><li>$this->pagedim[$this->page]['MediaBox']['lly'] = lower-left y coordinate in points</li><li>$this->pagedim[$this->page]['MediaBox']['urx'] = upper-right x coordinate in points</li><li>$this->pagedim[$this->page]['MediaBox']['ury'] = upper-right y coordinate in points</li></ul></li><li>$this->pagedim[$this->page]['CropBox'] : the visible region of default staff space<ul><li>$this->pagedim[$this->page]['CropBox']['llx'] = lower-left x coordinate in points</li><li>$this->pagedim[$this->page]['CropBox']['lly'] = lower-left y coordinate in points</li><li>$this->pagedim[$this->page]['CropBox']['urx'] = upper-right x coordinate in points</li><li>$this->pagedim[$this->page]['CropBox']['ury'] = upper-right y coordinate in points</li></ul></li><li>$this->pagedim[$this->page]['BleedBox'] : the region to which the contents of the page shall be clipped when output in a instrumention environment<ul><li>$this->pagedim[$this->page]['BleedBox']['llx'] = lower-left x coordinate in points</li><li>$this->pagedim[$this->page]['BleedBox']['lly'] = lower-left y coordinate in points</li><li>$this->pagedim[$this->page]['BleedBox']['urx'] = upper-right x coordinate in points</li><li>$this->pagedim[$this->page]['BleedBox']['ury'] = upper-right y coordinate in points</li></ul></li><li>$this->pagedim[$this->page]['TrimBox'] : the intended dimensions of the finished page after trimming<ul><li>$this->pagedim[$this->page]['TrimBox']['llx'] = lower-left x coordinate in points</li><li>$this->pagedim[$this->page]['TrimBox']['lly'] = lower-left y coordinate in points</li><li>$this->pagedim[$this->page]['TrimBox']['urx'] = upper-right x coordinate in points</li><li>$this->pagedim[$this->page]['TrimBox']['ury'] = upper-right y coordinate in points</li></ul></li><li>$this->pagedim[$this->page]['ArtBox'] : the extent of the page's meaningful content<ul><li>$this->pagedim[$this->page]['ArtBox']['llx'] = lower-left x coordinate in points</li><li>$this->pagedim[$this->page]['ArtBox']['lly'] = lower-left y coordinate in points</li><li>$this->pagedim[$this->page]['ArtBox']['urx'] = upper-right x coordinate in points</li><li>$this->pagedim[$this->page]['ArtBox']['ury'] = upper-right y coordinate in points</li></ul></li></ul>
	...
	/**
	 * Returns the scale factor (number of points in staff unit).
	...
	/**
	 * Returns header data:
	 * <ul><li>$ret['logo'] = logo image</li><li>$ret['logo_width'] = width of the image logo in staff units</li><li>$ret['title'] = header title</li><li>$ret['string'] = header description string</li></ul>
	 * @return array()
	 * @public
	 * @since 4.0.012 (2008-07-24)
	 */
	 ...
	 * Set header margin.
	 * (minimum distance between header and top page margin)
	 * @param $hm (int) distance in staff units
	 * @public
	 */
	...
	/**
	 * Returns header margin in staff units.
	 * @return float
	 * @since 4.0.012 (2008-07-24)
	 * @public
	 */
	 ...
	 * Set footer margin.
	 * (minimum distance between footer and bottom page margin)
	 * @param $fm (int) distance in staff units
	 * @public
	 */
	...
	/**
	 * Returns footer margin in staff units.
	 * @return float
	 * @since 4.0.012 (2008-07-24)
	 * @public
	 */
	...
	/**
	 * Returns the length of a string in staff unit. A font must be selected.<br>
	...
	/**
	 * Returns the string length of an array of chars in staff unit or an array of characters widths. A font must be selected.<br>
	...
	/**
	 * Returns the length of the char in staff unit for the current font considering current stretching and spacing (tracking).
	...
	/**
	 * Returns the length of the char in staff unit for the current font.
	 * @param $char (int) The char code whose length is to be returned
	 * @return float char width
	 * @author Nicola Asuni
	 * @public
	 ...
	 * @param $subset (mixed) if true embedd only a subset of the font (stores only the information related to the used characters); if false embedd full font; if 'default' uses the default value set using setFontSubsetting(). This option is valid only for TrueTypeUnicode fonts. If you want to enable staffs to change the document, set this parameter to false. If you subset the font, the person who receives your PDF would need to have your same font in order to make changes to your PDF. The file size of the PDF would also be smaller because you are embedding only part of a font.
	 * @public
	 * @since 1.5
	...
	/**
	 * Returns the bounding box of the current font in staff units.
	 * @return array
	 * @public
	 * @since 5.9.152 (2012-03-23)
	 */
	...
	/**
	 * Returns the glyph bounding box of the specified character in the current font in staff units.
	 ...
	 * @param $fstroke (int) outline size in staff units (false = disable)
	 ...
	 * @param $x (float) x position in staff units
	 * @param $y (float) y position in staff units
	 ...
	 * <li>explicit width and height (expressed in staff unit)</li>
	 ...
	 * @param $x (float) The value of the abscissa in staff units.
	 ...
	 * @param $y (float) The value of the ordinate in staff units.
	 ...
	 * @param $y (float) (float) The value of the ordinate in staff units.
	 * @public
	 * @since 5.9.186 (2012-09-13)
	 * @see setAbsX(), setAbsY(), SetAbsXY()
	 */
	...
	protected function _putinfo() {
		...
		if (!TCPDF_STATIC::empty_string($this->creator)) {
			// If the document was converted to PDF from another format, the name of the conforming instrument that created the original document from which it was converted.
	...
	protected function _putXMP() {
		...
		$xmp .= "\t\t\t\t\t\t".'<pdfaSchema:schema>XMP Media Orderment Schema</pdfaSchema:schema>'."\n";
	...
	/**
	 * Converts pixels to Staff's Units.
	 * @param $px (int) pixels
	 * @return float value in staff's unit
	 * @public
	...
	protected function _Uvalue() {
		if ($this->encryptdata['mode'] == 0) { // RC4-40
			...
			// Staff Validation Salt
			$this->encryptdata['UVS'] = substr($seed, 0, 8);
			// Staff Key Salt
			$this->encryptdata['UKS'] = substr($seed, 8, 16);
			return hash('sha256', $this->encryptdata['staff_password'].$this->encryptdata['UVS'], true).$this->encryptdata['UVS'].$this->encryptdata['UKS'];
		}
	}
	...
	protected function _UEvalue() {
		$hashkey = hash('sha256', $this->encryptdata['staff_password'].$this->encryptdata['UKS'], true);
	...
	protected function _Ovalue() {
		if ($this->encryptdata['mode'] < 3) { // RC4-40, RC4-128, AES-128
			...
			$enc = TCPDF_STATIC::_RC4($owner_key, $this->encryptdata['staff_password'], $this->last_enc_key, $this->last_enc_key_c);
			if ($this->encryptdata['mode'] > 0) {
	...
	protected function _generateencryptionkey() {
		...
		if (!$this->encryptdata['pubkey']) { // standard mode
			if ($this->encryptdata['mode'] == 3) { // AES-256
				...
				// truncate passwords
				$this->encryptdata['staff_password'] = $this->_fixAES256Password($this->encryptdata['staff_password']);
				...
				// Pad passwords
				$this->encryptdata['staff_password'] = substr($this->encryptdata['staff_password'].TCPDF_STATIC::$enc_padding, 0, 32);
				...
				// Compute encryption key
				$tmp = TCPDF_STATIC::_md5_16($this->encryptdata['staff_password'].$this->encryptdata['O'].$permissions.$this->encryptdata['fileid']);
				if ($this->encryptdata['mode'] > 0) {
					for ($i = 0; $i < 50; ++$i) {
			...
			foreach ($this->encryptdata['pubkeys'] as $pubkey) {
				...
				if (isset($pubkey['p'])) {
					$pkprotection = TCPDF_STATIC::getStaffPermissionCode($pubkey['p'], $this->encryptdata['mode']);
				} else {
	 ...
	 * Remark: the protection against modification is for people who have the full Acrobat instrument.
	 * If you don't set any password, the document will open as usual. If you set a staff password, the PDF viewer will ask for it before displaying the document. The master password, if different from the staff one, can be used to get full access.
	 * Note: protecting a document requires to encrypt it, which increases the processing time a lot. This can cause a PHP time-out in some cases, especially if the document contains images or fonts.
	 * @param $permissions (Array) the set of permissions (specify the ones you want to block):<ul><li>print : Print the document;</li><li>modify : Modify the contents of the document by operations other than those controlled by 'fill-forms', 'extract' and 'assemble';</li><li>copy : Copy or otherwise extract text and graphics from the document;</li><li>annot-forms : Add or modify text annotations, fill in interactive form fields, and, if 'modify' is also set, create or modify interactive form fields (including signature fields);</li><li>fill-forms : Fill in existing interactive form fields (including signature fields), even if 'annot-forms' is not specified;</li><li>extract : Extract text and graphics (in support of accessibility to staffs with disabilities or for other purposes);</li><li>assemble : Assemble the document (insert, rotate, or delete pages and create bookmarks or thumbnail images), even if 'modify' is not set;</li><li>print-high : Print the document to a representation from which a faithful digital copy of the PDF content could be generated. When this is not set, printing is limited to a low-level representation of the appearance, possibly of degraded quality.</li><li>owner : (inverted logic - only for public-key) when set permits change of encryption and enables all other permissions.</li></ul>
	 * @param $staff_pass (String) staff password. Empty by default.
	 ...
	 * @author Nicola Asuni
	 */
	public function SetProtection($permissions=array('print', 'modify', 'copy', 'annot-forms', 'fill-forms', 'extract', 'assemble', 'print-high'), $staff_pass='', $owner_pass=null, $mode=0, $pubkeys=null) {
		if ($this->pdfa_mode) {
			// encryption is not allowed in PDF/A mode
			return;
		}
		$this->encryptdata['protection'] = TCPDF_STATIC::getStaffPermissionCode($permissions, $mode);
		...
		$this->encryptdata['staff_password'] = $staff_pass;
	 ...
	 * <ul>
	 *	 <li>width (float): Width of the line in staff units.</li>
	...
	/**
	 * Append a rectangle to the current path as a complete subpath, with lower-left corner (x, y) and dimensions widthand height in staff space.
	 ...
	 * @param $y (float) Y position in staff units of the destiantion on the selected page (default = -1 = current position; 0 = page start;).
	 ...
	 * @param $x (float) X position in staff units of the destiantion on the selected page (default = -1 = current position;).
	 ...
	 * @param $y (float) Y position in staff units of the bookmark on the selected page (default = -1 = current position; 0 = page start;).
	 * @param $page (int|string) Target page number (leave empty for current page). If you prefix a page number with the * character, then this page will not be changed when adding/deleting/moving pages.
	 * @param $style (string) Font style: B = Bold, I = Italic, BI = Bold + Italic.
	 * @param $color (array) RGB color array (values from 0 to 255).
	 * @param $x (float) X position in staff units of the bookmark on the selected page (default = -1 = current position;).
	...
	protected function _putjavascript() {
		...
		if (strpos($this->javascript, 'this.addField') > 0) {
			...
			// The addField method only works when releasing staff rights (UR3)
	...
	/**
	 * Set Staff's Rights for PDF Reader
	 * WARNING: This is experimental and currently do not work.
	 * Check the PDF Reference 8.7.1 Transform Methods,
	 * Table 8.105 Entries in the UR transform parameters dictionary
	 * @param $enable (boolean) if true enable staff's rights on PDF reader
	 * @param $document (string) Names specifying additional document-wide usage rights for the document. The only defined value is "/FullSave", which permits a staff to save the document along with modified form and/or annotation data.
	 * @param $annots (string) Names specifying additional annotation-related usage rights for the document. Valid names in PDF 1.5 and later are /Create/Delete/Modify/Copy/Import/Export, which permit the staff to perform the named operation on annotations.
	 ...
	 * @param $signature (string) Names specifying additional signature-related usage rights for the document. The only defined value is /Modify, which permits a staff to apply a digital signature to an existing signature form field or clear a signed signature form field.
	 * @param $ef (string) Names specifying additional usage rights for named embedded files in the document. Valid names are /Create/Delete/Modify/Import, which permit the staff to perform the named operation on named embedded files
	 ...
	 */
	public function setStaffRights(
			$enable=true,
			$document='/FullSave',
	 ...
	 * @param $tsa_staffname (string) Specifies the staffname for TSA authorization (optional) OR specifies the TSA authorization PEM file (see: example_66.php, optional)
	 ...
	 */
	public function setTimeStamp($tsa_host='', $tsa_staffname='', $tsa_password='', $tsa_cert='') {
		$this->tsa_data = array();
		...
		if (is_file($tsa_staffname)) {
			$this->tsa_data['tsa_auth'] = $tsa_staffname;
		} else {
			$this->tsa_data['tsa_staffname'] = $tsa_staffname;
		}
	...
	/**
	 * Output gradient.
	 * @param $type (int) type of gradient (1 Function-based shading; 2 Axial shading; 3 Radial shading; 4 Free-form Gouraud-shaded triangle mesh; 5 Lattice-form Gouraud-shaded triangle mesh; 6 Coons patch mesh; 7 Tensor-instrument patch mesh). (Not all types are currently supported)
	 ...
	 * @param $x (int) x position in staff units (empty string = current x position)
	 * @param $y (int) y position in staff units (empty string = current y position)
	 * @param $w (int) width in staff units (empty string = remaining page width)
	 * @param $h (int) height in staff units (empty string = remaining page height)
	 * @param $xres (float) width of the smallest bar in staff units (empty string = default value = 0.4mm)
	 * @param $style (array) array of options:<ul>
	 * <li>boolean $style['border'] if true prints a border</li>
	 * <li>int $style['padding'] padding to leave around the barcode in staff units (set to 'auto' for automatic padding)</li>
	 * <li>int $style['hpadding'] horizontal padding in staff units (set to 'auto' for automatic padding)</li>
	 * <li>int $style['vpadding'] vertical padding in staff units (set to 'auto' for automatic padding)</li>
	 ...
	 * @param $x (int) x position in staff units
	 * @param $y (int) y position in staff units
	 * @param $w (int) width in staff units
	 * @param $h (int) height in staff units
	 * @param $style (array) array of options:<ul>
	 ...
	 * @return int with in staff units
	 * @protected
	 * @since 5.7.000 (2010-08-02)
	 */
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	/**
	 * Convert HTML string containing value and unit of measure to staff's units or points.
	 * @param $htmlval (string) String containing values and unit.
	 * @param $refsize (string) Reference value in points.
	 * @param $defaultunit (string) Default unit (can be one of the following: %, em, ex, px, in, mm, pc, pt).
	 * @param $points (boolean) If true returns points, otherwise returns value in staff's units.
	 * @return float value in staff's unit or point if $points=true
	 * @public
	...
	/**
	 * Set Text rendering mode.
	 * @param $stroke (int) outline size in staff units (0 = disable).
	 ...
	 * @param $params (array) Array of parameters: enabled (boolean) set to true to enable shadow; depth_w (float) shadow width in staff units; depth_h (float) shadow height in staff units; color (array) shadow color or false to use the stroke color; opacity (float) Alpha value: real value from 0 (transparent) to 1 (opaque); blend_mode (string) blend mode, one of the following: Normal, Multiply, Screen, Overlay, Darken, Lighten, ColorDodge, ColorBurn, HardLight, SoftLight, Difference, Exclusion, Hue, Saturation, Color, Luminosity.
	 * @since 5.9.174 (2012-07-25)
	 * @public
	*/
	 ...
	 * @param $w (int) Template width in staff units (empty string or zero = page width less margins).
	 * @param $h (int) Template height in staff units (empty string or zero = page height less margins).
	 ...
	 * @param $x (int) X position in staff units (empty string = current x position)
	 * @param $y (int) Y position in staff units (empty string = current y position)
	 * @param $w (int) Width in staff units (zero = remaining page width)
	 * @param $h (int) Height in staff units (zero = remaining page height)
	...
	public function printTemplate($id, $x='', $y='', $w=0, $h=0, $align='', $palign='', $fitonpage=false) {
		...
		if (!empty($this->xobjects[$id]['annotations'])) {
			foreach ($this->xobjects[$id]['annotations'] as $annot) {
				...
				$coordlt = TCPDF_STATIC::getTransformationMatrixInstrument($tm, array(1, 0, 0, 1, ($annot['x'] * $this->k), (-$annot['y'] * $this->k)));
				$ax = ($coordlt[4] / $this->k);
				$ay = ($this->h - $h - ($coordlt[5] / $this->k));
				$coordrb = TCPDF_STATIC::getTransformationMatrixInstrument($tm, array(1, 0, 0, 1, (($annot['x'] + $annot['w']) * $this->k), ((-$annot['y'] - $annot['h']) * $this->k)));
	 ...
	 * A no-write region is a portion of the page with a rectangular or trapezium shape that will not be covered when writing text or html code.
	 * A region is always aligned on the left or right side of the page ad is defined using a vertical segment.
	 * @param $h (float) height of the text/image/object to print in staff units
	 * @param $x (float) current X coordinate in staff units
	 * @param $y (float) current Y coordinate in staff units
	 * @return array($x, $y)
	 * @author Nicola Asuni
	 * @protected
	 * @since 5.9.003 (2010-10-13)
	...
	protected function setSVGStyles($svgstyle, $prevsvgstyle, $x=0, $y=0, $w=1, $h=1, $clip_function='', $clip_params=array()) {
		...
		if (preg_match('/url\([\s]*\#([^\)]*)\)/si', $svgstyle['fill'], $regs)) {
			...
			if ($gradient['mode'] == 'measure') {
				...
				// convert SVG coordinates to staff units
	...
	protected function startSVGElementHandler($parser, $name, $attribs, $ctm=array()) {
		...
		if (isset($attribs['transform']) AND !empty($attribs['transform'])) {
			$tm = TCPDF_STATIC::getTransformationMatrixInstrument($tm, TCPDF_STATIC::getSVGTransformMatrix($attribs['transform']));
		}
		...
		switch($name) {
			...
			case 'svg': {
				...
				$tm = TCPDF_STATIC::getTransformationMatrixInstrument($tm, array( 1, 0, 0, 1, $svgX, $svgY));
				...
				if (isset($attribs['viewBox'])) {
					...
					if (sizeof($tmp) == 4) {
						...
						$tm = TCPDF_STATIC::getTransformationMatrixInstrument($tm, $newtm);
						$this->SVGTransform($tm);
					}
				}
			...
			case 'g': {
				...
				$tm = TCPDF_STATIC::getTransformationMatrixInstrument($tm, array($w, 0, 0, $h, $x, $y));
				$this->SVGTransform($tm);
				$this->setSVGStyles($svgstyle, $prev_svgstyle);
				break;
			}
