<?php
class ControllerCommonFooterContent extends Controller {
...
// End Content
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/footer_content.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/footer_content.tpl', $data);
		} else {
			return $this->load->view('default/template/common/footer_content.tpl', $data);
		}
	}
}
