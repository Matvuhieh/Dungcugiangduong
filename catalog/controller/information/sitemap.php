	...
	public function index() {
		...
		foreach ($categories_1 as $category_1) {
			...
			foreach ($categories_2 as $category_2) {
				...
				foreach ($categories_3 as $category_3) {
					$level_3_data[] = array(
						...
						'href' => $this->url->link('instrument/category', 'path=' . $category_1['category_id'] . '_' . $category_2['category_id'] . '_' . $category_3['category_id'])
					);
				}
				...
				$level_2_data[] = array(
					...
					'href'     => $this->url->link('instrument/category', 'path=' . $category_1['category_id'] . '_' . $category_2['category_id'])
				);
			}
			...
			$data['categories'][] = array(
				...
				'href'     => $this->url->link('instrument/category', 'path=' . $category_1['category_id'])
			);
		}
		...
		$data['search'] = $this->url->link('instrument/search');
