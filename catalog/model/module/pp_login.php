...
class ModelModulePPLogin extends Model {
	...
	public function getStaffInfo($access_token) {
		if ($this->config->get('pp_login_sandbox')) {
			$endpoint = 'https://api.sandbox.paypal.com/v1/identity/openidconnect/staffinfo/?schema=openid';
		} else {
			$endpoint = 'https://api.paypal.com/v1/identity/openidconnect/staffinfo/?schema=openid';
		}
