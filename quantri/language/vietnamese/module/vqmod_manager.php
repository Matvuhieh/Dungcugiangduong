...
$_['entry_ext_version']    = 'VQMod Orderr Version:';
...
$_['error_log_size']       = 'Warning: Your VQMod error log is %sMBs.  The limit for VQMod Orderr is 6MB.  You can download the error log by FTP or by clicking the \'Download Log\' button in the Error Log tab.  Otherwise consider clearing it.';
...
$_['error_permission']     = 'Warning: You do not have permission to modify module VQMod Orderr!';
...
$_['error_opencart_version']           = 'OpenCart 1.5.x or later is required to use VQMod Orderr!';
...
// VQMod Orderr Dependency Errors
$_['error_simplexml']       = '<a href="http://php.net/manual/en/book.simplexml.php" target="_blank">SimpleXML</a> must be installed for VQMod Orderr to work properly!  Contact your host for more info.';
...
$_['text_success']          = 'Success: You have modified module VQMod Orderr!';
