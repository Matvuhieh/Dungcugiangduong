...
$_['text_ip_staff_type']                       = 'IP Staff Type:';
...
$_['text_high_risk_staffname']                 = 'High Risk Staffname:';
...
$_['text_user_phone_in_billing_location'] = 'User Phone Number in Billing Location:';
...
$_['help_ip_staff_type']                       = 'Estimated staff type of the IP address.';
...
$_['help_ip_accuracy_radius']                 = 'The average distance between the actual location of the end staff using the IP address and the location returned by the GeoIP City database, in miles.';
...
$_['help_high_risk_staffname']                 = 'Whether staffnameMD5 input is in database of high risk staffnames. Only returned if staffnameMD5 is included in inputs.';
...
$_['help_bin_phone_match']                    = 'Whether user service phone number matches inputed BIN Phone. A return value of Yes provides a positive indication that cardholder is in possession of credit card.';
$_['help_bin_phone']                          = 'User service phone number listed on back of credit card. Available for approximately 75% of BIN numbers. In some cases phone number returned may be outdated.';
$_['help_user_phone_in_billing_location'] = 'Whether the user phone number is in the billing zip code. A return value of Yes provides a positive indication that the phone number listed belongs to the cardholder. A return value of No indicates that the phone number may be in a different area, or may not be listed in our database. NotFound is returned when the phone number prefix cannot be found in our database at all. Currently we only support US Phone numbers.';
