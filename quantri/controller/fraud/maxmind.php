...
class ControllerFraudMaxMind extends Controller {
	...
	protected function validate() {
		if (!$this->staff->hasPermission('modify', 'fraud/maxmind')) {
	...
	public function order() {
		...
		if ($fraud_info) {
			...
			$data['text_ip_staff_type'] = $this->language->get('text_ip_staff_type');
			...
			$data['text_high_risk_staffname'] = $this->language->get('text_high_risk_staffname');
			...
			$data['text_user_phone_in_billing_location'] = $this->language->get('text_user_phone_in_billing_location');
			...
			$data['help_ip_staff_type'] = $this->language->get('help_ip_staff_type');
			...
			$data['help_high_risk_staffname'] = $this->language->get('help_high_risk_staffname');
			...
			$data['help_user_phone_in_billing_location'] = $this->language->get('help_user_phone_in_billing_location');
			...
			if ($fraud_info['ip_staff_type']) {
				$data['ip_staff_type'] = $fraud_info['ip_staff_type'];
			} else {
				$data['ip_staff_type'] = '';
			}
			...
			if ($fraud_info['high_risk_staffname']) {
				$data['high_risk_staffname'] = $fraud_info['high_risk_staffname'];
			} else {
				$data['high_risk_staffname'] = '';
			}
			...
			if ($fraud_info['user_phone_in_billing_location']) {
				$data['user_phone_in_billing_location'] = $fraud_info['user_phone_in_billing_location'];
			} else {
				$data['user_phone_in_billing_location'] = '';
			}
