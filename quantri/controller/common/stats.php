...
class ControllerCommonStats extends Controller {
	public function index() {
		...
		$order_total = $this->model_manage_order->getTotalOrders();

		$complete_total = $this->model_manage_order->getTotalOrders(array('filter_order_status' => implode(',', $this->config->get('config_complete_status'))));
		...
		$processing_total = $this->model_manage_order->getTotalOrders(array('filter_order_status' => implode(',', $this->config->get('config_processing_status'))));
		...
		$other_total = $this->model_manage_order->getTotalOrders(array('filter_order_status' => implode(',', $order_status_data)));
