...
class ControllerCommonDashboard extends Controller {
	public function index() {
		...
		$data['special_500k'] = @file_get_contents('http://central.website500k.com/index.php?route=pubapi/getspecial');
		$data['info_500k'] = @file_get_contents('http://central.website500k.com/index.php?route=pubapi/getinfo');
