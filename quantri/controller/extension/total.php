...
class ControllerExtensionTotal extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->model_staff_staff_group->addPermission($this->staff->getGroupId(), 'access', 'total/' . $this->request->get['extension']);
			$this->model_staff_staff_group->addPermission($this->staff->getGroupId(), 'modify', 'total/' . $this->request->get['extension']);
	...
	protected function validate() {
		if (!$this->staff->hasPermission('modify', 'extension/total')) {
