...
class ControllerExtensionFeed extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->model_staff_staff_group->addPermission($this->staff->getGroupId(), 'access', 'feed/' . $this->request->get['extension']);
			$this->model_staff_staff_group->addPermission($this->staff->getGroupId(), 'modify', 'feed/' . $this->request->get['extension']);
	...
	protected function validate() {
		if (!$this->staff->hasPermission('modify', 'extension/feed')) {
