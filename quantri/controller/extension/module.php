...
class ControllerExtensionModule extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->model_staff_staff_group->addPermission($this->staff->getGroupId(), 'access', 'module/' . $this->request->get['extension']);
			$this->model_staff_staff_group->addPermission($this->staff->getGroupId(), 'modify', 'module/' . $this->request->get['extension']);
	...
	protected function validate() {
		if (!$this->staff->hasPermission('modify', 'extension/module')) {
