...
class ControllerSettingStore extends Controller {
	...
	public function getForm() {
		...
		} elseif (isset($store_info['config_instrument_limit'])) {
			$data['config_instrument_limit'] = $store_info['config_instrument_limit'];
		} else {
			$data['config_instrument_limit'] = '15';
		}
		...
		} elseif (isset($store_info['config_instrument_description_length'])) {
			$data['config_instrument_description_length'] = $store_info['config_instrument_description_length'];
		} else {
			$data['config_instrument_description_length'] = '100';
		}
		...
		} elseif (isset($store_info['config_tax_user'])) {
			$data['config_tax_user'] = $store_info['config_tax_user'];
		} else {
			$data['config_tax_user'] = '';
		}

		if (isset($this->request->post['config_user_group_id'])) {
			$data['config_user_group_id'] = $this->request->post['config_user_group_id'];
		} elseif (isset($store_info['config_user_group_id'])) {
			$data['config_user_group_id'] = $store_info['config_user_group_id'];
		} else {
			$data['config_user_group_id'] = '';
		}
		...
		} elseif (isset($store_info['config_user_group_display'])) {
			$data['config_user_group_display'] = $store_info['config_user_group_display'];
		} else {
		...
		} elseif (isset($store_info['config_user_price'])) {
			$data['config_user_price'] = $store_info['config_user_price'];
		} else {
			$data['config_user_price'] = '';
		}
		...
		} elseif (isset($store_info['config_borrow_guest'])) {
			$data['config_borrow_guest'] = $store_info['config_borrow_guest'];
		} else {
			$data['config_borrow_guest'] = '';
		}

		if (isset($this->request->post['config_borrow_id'])) {
			$data['config_borrow_id'] = $this->request->post['config_borrow_id'];
		} elseif (isset($store_info['config_borrow_id'])) {
			$data['config_borrow_id'] = $store_info['config_borrow_id'];
		} else {
			$data['config_borrow_id'] = '';
		}
		...
		} elseif (isset($store_info['config_stock_borrow'])) {
			$data['config_stock_borrow'] = $store_info['config_stock_borrow'];
		} else {
			$data['config_stock_borrow'] = '';
		}
		...
		} elseif (isset($store_info['config_image_instrument_width'])) {
			$data['config_image_instrument_width'] = $store_info['config_image_instrument_width'];
		} else {
			$data['config_image_instrument_width'] = 80;
		}
		...
		} elseif (isset($store_info['config_image_instrument_height'])) {
			$data['config_image_instrument_height'] = $store_info['config_image_instrument_height'];
		} else {
			$data['config_image_instrument_height'] = 80;
		}
	...
	protected function validateForm() {
		if (!$this->staff->hasPermission('modify', 'setting/store')) {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $store_id) {
			...
			$store_total = $this->model_manage_order->getTotalOrdersByStoreId($store_id);
