...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_embed_code'] = $this->language->get('entry_embed_code');
		...
		$data['entry_instrument_limit'] = $this->language->get('entry_instrument_limit');
		$data['entry_instrument_description_length'] = $this->language->get('entry_instrument_description_length');
		$data['entry_limit_admin'] = $this->language->get('entry_limit_admin');
		$data['entry_instrument_count'] = $this->language->get('entry_instrument_count');
		...
		$data['entry_tax_user'] = $this->language->get('entry_tax_user');
		$data['entry_user_online'] = $this->language->get('entry_user_online');
		$data['entry_user_group'] = $this->language->get('entry_user_group');
		$data['entry_user_group_display'] = $this->language->get('entry_user_group_display');
		$data['entry_user_price'] = $this->language->get('entry_user_price');
		...
		$data['entry_borrow_guest'] = $this->language->get('entry_borrow_guest');
		$data['entry_borrow'] = $this->language->get('entry_borrow');
		...
		$data['entry_stock_borrow'] = $this->language->get('entry_stock_borrow');
		...
		$data['entry_image_instrument'] = $this->language->get('entry_image_instrument');
		...
		$data['entry_ftp_staffname'] = $this->language->get('entry_ftp_staffname');
		...
		$data['entry_mail_smtp_staffname'] = $this->language->get('entry_mail_smtp_staffname');
		...
		$data['entry_building'] = $this->language->get('entry_building');
		...
		$data['help_instrument_limit'] = $this->language->get('help_instrument_limit');
		$data['help_instrument_description_length'] = $this->language->get('help_instrument_description_length');
		$data['help_limit_admin'] = $this->language->get('help_limit_admin');
		$data['help_instrument_count'] = $this->language->get('help_instrument_count');
		...
		$data['help_tax_user'] = $this->language->get('help_tax_user');
		$data['help_user_online'] = $this->language->get('help_user_online');
		$data['help_user_group'] = $this->language->get('help_user_group');
		$data['help_user_group_display'] = $this->language->get('help_user_group_display');
		$data['help_user_price'] = $this->language->get('help_user_price');
		...
		$data['help_borrow_guest'] = $this->language->get('help_borrow_guest');
		$data['help_borrow'] = $this->language->get('help_borrow');
		...
		$data['help_stock_borrow'] = $this->language->get('help_stock_borrow');
		...
		$data['help_watermark'] = $this->language->get('help_watermark');
		...
		$data['tab_community'] = $this->language->get('tab_community');
		...
		if (isset($this->error['user_group_display'])) {
			$data['error_user_group_display'] = $this->error['user_group_display'];
		} else {
			$data['error_user_group_display'] = '';
		}
		...
		if (isset($this->error['ftp_staffname'])) {
			$data['error_ftp_staffname'] = $this->error['ftp_staffname'];
		} else {
			$data['error_ftp_staffname'] = '';
		}
		...
		if (isset($this->error['image_instrument'])) {
			$data['error_image_instrument'] = $this->error['image_instrument'];
		} else {
			$data['error_image_instrument'] = '';
		}
		...
		if (isset($this->error['instrument_limit'])) {
			$data['error_instrument_limit'] = $this->error['instrument_limit'];
		} else {
			$data['error_instrument_limit'] = '';
		}

		if (isset($this->error['instrument_description_length'])) {
			$data['error_instrument_description_length'] = $this->error['instrument_description_length'];
		} else {
			$data['error_instrument_description_length'] = '';
		}
		...
		if (isset($this->request->post['config_embed_code'])) {
			$data['config_embed_code'] = $this->request->post['config_embed_code'];
		} else {
			$data['config_embed_code'] = $this->config->get('config_embed_code');
		}
		...
		if (isset($this->request->post['config_instrument_limit'])) {
			$data['config_instrument_limit'] = $this->request->post['config_instrument_limit'];
		} else {
			$data['config_instrument_limit'] = $this->config->get('config_instrument_limit');
		}

		if (isset($this->request->post['config_instrument_description_length'])) {
			$data['config_instrument_description_length'] = $this->request->post['config_instrument_description_length'];
		} else {
			$data['config_instrument_description_length'] = $this->config->get('config_instrument_description_length');
		}
		...
		if (isset($this->request->post['config_instrument_count'])) {
			$data['config_instrument_count'] = $this->request->post['config_instrument_count'];
		} else {
			$data['config_instrument_count'] = $this->config->get('config_instrument_count');
		}
		...
		if (isset($this->request->post['config_tax_user'])) {
			$data['config_tax_user'] = $this->request->post['config_tax_user'];
		} else {
			$data['config_tax_user'] = $this->config->get('config_tax_user');
		}

		if (isset($this->request->post['config_user_online'])) {
			$data['config_user_online'] = $this->request->post['config_user_online'];
		} else {
			$data['config_user_online'] = $this->config->get('config_user_online');
		}
		...
		if (isset($this->request->post['config_user_group_display'])) {
			$data['config_user_group_display'] = $this->request->post['config_user_group_display'];
		} elseif ($this->config->get('config_user_group_display')) {
			$data['config_user_group_display'] = $this->config->get('config_user_group_display');
		} else {
			$data['config_user_group_display'] = array();
		}

		if (isset($this->request->post['config_user_price'])) {
			$data['config_user_price'] = $this->request->post['config_user_price'];
		} else {
			$data['config_user_price'] = $this->config->get('config_user_price');
		}
		...
		if (isset($this->request->post['config_borrow_guest'])) {
			$data['config_borrow_guest'] = $this->request->post['config_borrow_guest'];
		} else {
			$data['config_borrow_guest'] = $this->config->get('config_borrow_guest');
		}

		if (isset($this->request->post['config_borrow_id'])) {
			$data['config_borrow_id'] = $this->request->post['config_borrow_id'];
		} else {
			$data['config_borrow_id'] = $this->config->get('config_borrow_id');
		}
		...
		$data['apis'] = $this->model_staff_api->getApis();
		...
		if (isset($this->request->post['config_stock_borrow'])) {
			$data['config_stock_borrow'] = $this->request->post['config_stock_borrow'];
		} else {
			$data['config_stock_borrow'] = $this->config->get('config_stock_borrow');
		}
		...
		if (isset($this->request->post['config_watermark']) && is_file(DIR_IMAGE . $this->request->post['config_watermark'])) {
			$data['watermark'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
			...
			$data['watermark'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_image_instrument_width'])) {
			$data['config_image_instrument_width'] = $this->request->post['config_image_instrument_width'];
		} else {
			$data['config_image_instrument_width'] = $this->config->get('config_image_instrument_width');
		}

		if (isset($this->request->post['config_image_instrument_height'])) {
			$data['config_image_instrument_height'] = $this->request->post['config_image_instrument_height'];
		} else {
			$data['config_image_instrument_height'] = $this->config->get('config_image_instrument_height');
		}
		...
		if (isset($this->request->post['config_ftp_staffname'])) {
			$data['config_ftp_staffname'] = $this->request->post['config_ftp_staffname'];
		} else {
			$data['config_ftp_staffname'] = $this->config->get('config_ftp_staffname');
		}
		...
		if (isset($this->request->post['config_mail_smtp_staffname'])) {
			$data['config_mail_smtp_staffname'] = $this->request->post['config_mail_smtp_staffname'];
		} else {
			$data['config_mail_smtp_staffname'] = $this->config->get('config_mail_smtp_staffname');
		}
		...
		if (isset($this->request->post['config_building'])) {
			$data['config_building'] = $this->request->post['config_building'];
		} else {
			$data['config_building'] = $this->config->get('config_building');
		}
	...
	protected function validate() {
		if (!$this->staff->hasPermission('modify', 'setting/setting')) {
		...
		if (!empty($this->request->post['config_user_group_display']) && !in_array($this->request->post['config_user_group_id'], $this->request->post['config_user_group_display'])) {
			$this->error['user_group_display'] = $this->language->get('error_user_group_display');
		}
		...
		if (!$this->request->post['config_image_instrument_width'] || !$this->request->post['config_image_instrument_height']) {
			$this->error['image_instrument'] = $this->language->get('error_image_instrument');
		}
		...
		if ($this->request->post['config_ftp_status']) {
			...
			if (!$this->request->post['config_ftp_staffname']) {
				$this->error['ftp_staffname'] = $this->language->get('error_ftp_staffname');
			}
		...
		if (!$this->request->post['config_instrument_limit']) {
			$this->error['instrument_limit'] = $this->language->get('error_limit');
		}

		if (!$this->request->post['config_instrument_description_length']) {
			$this->error['instrument_description_length'] = $this->language->get('error_limit');
		}
