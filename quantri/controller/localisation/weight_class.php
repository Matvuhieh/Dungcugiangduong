...
class ControllerLocalisationWeightClass extends Controller {
	...
	protected function validateForm() {
		if (!$this->staff->hasPermission('modify', 'localisation/weight_class')) {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $weight_class_id) {
			...
			$instrument_total = $this->model_catalog_instrument->getTotalInstrumentsByWeightClassId($weight_class_id);
