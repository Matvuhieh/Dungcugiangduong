...
class ControllerLocalisationLengthClass extends Controller {
	...
	protected function validateForm() {
		if (!$this->staff->hasPermission('modify', 'localisation/length_class')) {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $length_class_id) {
			...
			$instrument_total = $this->model_catalog_instrument->getTotalInstrumentsByLengthClassId($length_class_id);

			if ($instrument_total) {
				$this->error['warning'] = sprintf($this->language->get('error_instrument'), $instrument_total);
			}
		}
