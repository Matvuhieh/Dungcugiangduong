...
class ControllerLocalisationLanguage extends Controller {
	...
	protected function getList() {
		...
		$data['button_language_editor'] = $this->language->get('button_language_editor');
	...
	protected function validateForm() {
		if (!$this->staff->hasPermission('modify', 'localisation/language')) {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $language_id) {
			...
			$order_total = $this->model_manage_order->getTotalOrdersByLanguageId($language_id);
