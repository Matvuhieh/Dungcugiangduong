...
if(Formbuilder.helpers.placeholderStatus(rf.get(Formbuilder.options.mappings.FIELD_TYPE))) __p +=t;
...
'\'\n  placeholder=\''+dict['TEXT_ENTER_VALUE']+'\' /><br />'+dict['TEXT_VALUE_HINT']+'</div>';
...
'\'\n class="regex" placeholder=\''+dict['TEXT_REGEX']+'\' /><br /> '+dict['TEXT_REGEX_HINT']+'</div>';
