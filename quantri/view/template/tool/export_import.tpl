							...
							<table class="form">
								...
								<tr>
									<td style="vertical-align:top;">
										...
										<?php } ?>
										<?php echo $text_export_type_instrument; ?>
										<br />
										...
										<?php } ?>
										<?php echo $text_export_type_user; ?>
										<br />
									</td>
								</tr>
...
function checkFileSize(id) {
	...
	if (!window.FileReader) {
		// The file API isn't yet supported on staff's browser
		return true;
	}
...
function validateExportForm(id) {
	...
	var count_item;
	switch (export_type) {
		case 'p': count_item = <?php echo $count_instrument-1; ?>;  break;
		case 'c': count_item = <?php echo $count_category-1; ?>; break;
		default:  count_item = <?php echo $count_user-1; ?>; break;
	}
	...
	var minItemId;
	switch (export_type) {
		case 'p': minItemId = parseInt( <?php echo $min_instrument_id; ?> );  break;
		case 'c': minItemId = parseInt( <?php echo $min_category_id; ?> ); break;
		default:  minItemId = parseInt( <?php echo $min_user_id; ?> ); break;
	
	}
	var maxItemId;
	switch (export_type) {
		case 'p': maxItemId = parseInt( <?php echo $max_instrument_id; ?> );  break;
		case 'c': maxItemId = parseInt( <?php echo $max_category_id; ?> ); break;
		default:  maxItemId = parseInt( <?php echo $max_user_id; ?> ); break;
