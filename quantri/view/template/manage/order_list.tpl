        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-total"><?php echo $entry_code; ?></label>
                <input type="text" name="filter_code" value="<?php echo $filter_code; ?>" placeholder="<?php echo $entry_code; ?>" id="input-total" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'user') { ?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=manage/order&token=<?php echo $token; ?>';
