      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <?php if ($user_id) { ?>
            <li><a href="#tab-history" data-toggle="tab"><?php echo $tab_notification; ?></a></li>
          ...
          <div class="tab-content">
              ...
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="address">
                    <li class="active"><a href="#tab-user" data-toggle="tab"><?php echo $tab_general; ?></a></li>
                    <?php $address_row = 1; ?>
            ...
            <div class="tab-pane" id="tab-history">
              ...
              <div class="text-right">
                <button id="button-history" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_notification_add; ?></button>
              </div>
            </div>
            <?php } ?>
...
$('#history').load('index.php?route=user/user/history&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>');

$('#button-history').on('click', function(e) {
	e.preventDefault();

	$.ajax({
		url: 'index.php?route=user/user/addhistory&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#transaction').load('index.php?route=user/user/transaction&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>');

$('#button-transaction').on('click', function(e) {
  e.preventDefault();

  $.ajax({
		url: 'index.php?route=user/user/addtransaction&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#reward').load('index.php?route=user/user/reward&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>');

$('#button-reward').on('click', function(e) {
	e.preventDefault();

	$.ajax({
		url: 'index.php?route=user/user/addreward&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>',
		type: 'post',
		dataType: 'json',
...
$('#ip').load('index.php?route=user/user/ip&token=<?php echo $token; ?>&user_id=<?php echo $user_id; ?>');
