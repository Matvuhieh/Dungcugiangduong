      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <?php $user_group_row = 0; ?>
              <?php foreach ($user_groups as $user_group) { ?>
              <div class="checkbox">
                <label>
                  <?php if (in_array($user_group['user_group_id'], $custom_field_user_group)) { ?>
                  <input type="checkbox" name="custom_field_user_group[<?php echo $user_group_row; ?>][user_group_id]" value="<?php echo $user_group['user_group_id']; ?>" checked="checked" />
                  <?php echo $user_group['name']; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="custom_field_user_group[<?php echo $user_group_row; ?>][user_group_id]" value="<?php echo $user_group['user_group_id']; ?>" />
                  <?php echo $user_group['name']; ?>
                  <?php } ?>
                </label>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div class="checkbox">
                <label>
                  <?php if (in_array($user_group['user_group_id'], $custom_field_required)) { ?>
                  <input type="checkbox" name="custom_field_user_group[<?php echo $user_group_row; ?>][required]" value="<?php echo $user_group['user_group_id']; ?>" checked="checked" />
                  <?php echo $user_group['name']; ?>
                  <?php } else { ?>
                  <input type="checkbox" name="custom_field_user_group[<?php echo $user_group_row; ?>][required]" value="<?php echo $user_group['user_group_id']; ?>" />
                  <?php echo $user_group['name']; ?>
                  <?php } ?>
                </label>
              </div>
