      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-community" data-toggle="tab"><?php echo $tab_community; ?></a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-map-embed-code"><?php echo $entry_map_embed_code; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_map_embed_code" placeholder="<?php echo $entry_map_embed_code; ?>" rows="7" id="input-map-embed-code" class="form-control"><?php echo $config_map_embed_code; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-embed-code"><?php echo $entry_embed_code; ?></label>
                  <div class="col-sm-10">
                    <textarea name="config_embed_code" placeholder="<?php echo $entry_embed_code; ?>" rows="7" id="input-embed-code" class="form-control"><?php echo $config_embed_code; ?></textarea>
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_instrument_count; ?>"><?php echo $entry_instrument_count; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_instrument_count) { ?>
                      <input type="radio" name="config_instrument_count" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_instrument_count" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_instrument_count) { ?>
                      <input type="radio" name="config_instrument_count" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_instrument_count" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-catalog-limit"><span data-toggle="tooltip" title="<?php echo $help_instrument_limit; ?>"><?php echo $entry_instrument_limit; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_instrument_limit" value="<?php echo $config_instrument_limit; ?>" placeholder="<?php echo $entry_instrument_limit; ?>" id="input-catalog-limit" class="form-control" />
                    <?php if ($error_instrument_limit) { ?>
                    <div class="text-danger"><?php echo $error_instrument_limit; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-list-description-limit"><span data-toggle="tooltip" title="<?php echo $help_instrument_description_length; ?>"><?php echo $entry_instrument_description_length; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_instrument_description_length" value="<?php echo $config_instrument_description_length; ?>" placeholder="<?php echo $entry_instrument_description_length; ?>" id="input-list-description-limit" class="form-control" />
                    <?php if ($error_instrument_description_length) { ?>
                    <div class="text-danger"><?php echo $error_instrument_description_length; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group required">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-tax-user"><span data-toggle="tooltip" title="<?php echo $help_tax_user; ?>"><?php echo $entry_tax_user; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_tax_user" id="input-tax-user" class="form-control">
                      <option value=""><?php echo $text_none; ?></option>
                      <?php  if ($config_tax_user == 'shipping') { ?>
                      <option value="shipping" selected="selected"><?php echo $text_shipping; ?></option>
                      <?php } else { ?>
                      <option value="shipping"><?php echo $text_shipping; ?></option>
                      <?php } ?>
                      <?php  if ($config_tax_user == 'payment') { ?>
                      <option value="payment" selected="selected"><?php echo $text_payment; ?></option>
                      <?php } else { ?>
                      <option value="payment"><?php echo $text_payment; ?></option>
                      <?php } ?>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_user_online; ?>"><?php echo $entry_user_online; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_user_online) { ?>
                      <input type="radio" name="config_user_online" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_user_online" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_user_online) { ?>
                      <input type="radio" name="config_user_online" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_user_online" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-user-group"><span data-toggle="tooltip" title="<?php echo $help_user_group; ?>"><?php echo $entry_user_group; ?></span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_user_group_display; ?>"><?php echo $entry_user_group_display; ?></span></label>
                  <div class="col-sm-10">
                    <?php foreach ($user_groups as $user_group) { ?>
                    <div class="checkbox">
                      <label>
                    ...
                    <?php } ?>
                    <?php if ($error_user_group_display) { ?>
                    <div class="text-danger"><?php echo $error_user_group_display; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_user_price; ?>"><?php echo $entry_user_price; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_user_price) { ?>
                      <input type="radio" name="config_user_price" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_user_price" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_user_price) { ?>
                      <input type="radio" name="config_user_price" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_user_price" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
              ...
              <fieldset>
                <legend><?php echo $text_borrow; ?></legend>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_borrow_guest; ?>"><?php echo $entry_borrow_guest; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_borrow_guest) { ?>
                      <input type="radio" name="config_borrow_guest" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_borrow_guest" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_borrow_guest) { ?>
                      <input type="radio" name="config_borrow_guest" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_borrow_guest" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-borrow"><span data-toggle="tooltip" title="<?php echo $help_borrow; ?>"><?php echo $entry_borrow; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_borrow_id" id="input-borrow" class="form-control">
                      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($informations as $information) { ?>
                      <?php if ($information['information_id'] == $config_borrow_id) { ?>
                      <option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['title']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $information['information_id']; ?>"><?php echo $information['title']; ?></option>
                      <?php } ?>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_stock_borrow; ?>"><?php echo $entry_stock_borrow; ?></span></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_stock_borrow) { ?>
                      <input type="radio" name="config_stock_borrow" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_stock_borrow" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_stock_borrow) { ?>
                      <input type="radio" name="config_stock_borrow" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_stock_borrow" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-watermark"><span data-toggle="tooltip" title="<?php echo $help_watermark; ?>"><?php echo $entry_watermark; ?></span></label>
                <div class="col-sm-10"><a href="" id="thumb-watermark" data-toggle="image" class="img-thumbnail"><img src="<?php echo $watermark; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_watermark" value="<?php echo $config_watermark; ?>" id="input-watermark" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-instrument-width"><?php echo $entry_image_instrument; ?></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_instrument_width" value="<?php echo $config_image_instrument_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-instrument-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_instrument_height" value="<?php echo $config_image_instrument_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_instrument) { ?>
                  <div class="text-danger"><?php echo $error_image_instrument; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-ftp">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ftp-staffname"><?php echo $entry_ftp_staffname; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_ftp_staffname" value="<?php echo $config_ftp_staffname; ?>" placeholder="<?php echo $entry_ftp_staffname; ?>" id="input-ftp-staffname" class="form-control" />
                  <?php if ($error_ftp_staffname) { ?>
                  <div class="text-danger"><?php echo $error_ftp_staffname; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mail-smtp-staffname"><?php echo $entry_mail_smtp_staffname; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_mail_smtp_staffname" value="<?php echo $config_mail_smtp_staffname; ?>" placeholder="<?php echo $entry_mail_smtp_staffname; ?>" id="input-mail-smtp-staffname" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-server">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label"><?php echo $entry_building; ?></label>
                    <div class="col-sm-10">
                      <label class="radio-inline">
                        <?php if ($config_building) { ?>
                        <input type="radio" name="config_building" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                        <?php } else { ?>
                        <input type="radio" name="config_building" value="1" />
                        <?php echo $text_yes; ?>
                        <?php } ?>
                      </label>
                      <label class="radio-inline">
                        <?php if (!$config_building) { ?>
                        <input type="radio" name="config_building" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                        <?php } else { ?>
                        <input type="radio" name="config_building" value="0" />
                        <?php echo $text_no; ?>
                        <?php } ?>
                      </label>
                   </div>
