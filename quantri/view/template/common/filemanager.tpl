      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <label class="col-sm-2"><?php echo $entry_watermark; ?></label>
            <div class="col-sm-10">
              <input type="radio" name="watermark_selector" value="none" checked /> <?php echo $text_no; ?>
              <input type="radio" name="watermark_selector" value="topleft" /> <?php echo $text_top_left; ?>
              <input type="radio" name="watermark_selector" value="topright" /> <?php echo $text_top_right; ?>
              <input type="radio" name="watermark_selector" value="bottomleft" /> <?php echo $text_bottom_left; ?>
              <input type="radio" name="watermark_selector" value="bottomright" /> <?php echo $text_bottom_right; ?>
            </div>
          </div>
        </div>
      </div>
...
$('a.thumbnail').on('click', function(e) {
	...
	img.onload = function () {
		if(img.naturalWidth > $('.note-editor').innerWidth())
			img.style.width = '100%';
	}
...
$('#button-upload').on('click', function() {
	...
	$('body').prepend('<form enctype="multipart/form-data" id="form-upload" style="display: none;"><input type="file" name="file[]" value="" multiple /><input type="hidden" name="watermark" value="' + $('input[name="watermark_selector"]:checked').val() + '" /></form>');
