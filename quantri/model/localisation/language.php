...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		...
		// User Group
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "user_group_description WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $user_group) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "user_group_description SET user_group_id = '" . (int)$user_group['user_group_id'] . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($user_group['name']) . "', description = '" . $this->db->escape($user_group['description']) . "'");
		}
		...
		// Instrument
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "instrument_description WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $instrument) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "instrument_description SET instrument_id = '" . (int)$instrument['instrument_id'] . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($instrument['name']) . "', description = '" . $this->db->escape($instrument['description']) . "', tag = '" . $this->db->escape($instrument['tag']) . "', meta_title = '" . $this->db->escape($instrument['meta_title']) . "', meta_description = '" . $this->db->escape($instrument['meta_description']) . "', meta_keyword = '" . $this->db->escape($instrument['meta_keyword']) . "'");
		}

		$this->cache->delete('instrument');

		// Instrument Attribute
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "instrument_attribute WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $instrument_attribute) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "instrument_attribute SET instrument_id = '" . (int)$instrument_attribute['instrument_id'] . "', attribute_id = '" . (int)$instrument_attribute['attribute_id'] . "', language_id = '" . (int)$language_id . "', text = '" . $this->db->escape($instrument_attribute['text']) . "'");
		}
	...
	public function deleteLanguage($language_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "user_group_description WHERE language_id = '" . (int)$language_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "instrument_attribute WHERE language_id = '" . (int)$language_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "instrument_description WHERE language_id = '" . (int)$language_id . "'");
