...
// Url
$url = new Url(HTTP_SERVER, $config->get('config_secure') ? HTTPS_SERVER : HTTP_SERVER, HTTP_CATALOG, $config->get('config_secure') ? HTTPS_CATALOG : HTTP_CATALOG);
...
// API
if(!file_exists(DIR_SYSTEM.'library/api.php')){
...
// Staff
$registry->set('staff', new Staff($registry));
...
//ShortCodes
if(!file_exists(DIR_SYSTEM.'library/shortcodes.php')){
	header($_SERVER[ "SERVER_PROTOCOL" ].' 500 Internal Server Error');
	exit();
}
